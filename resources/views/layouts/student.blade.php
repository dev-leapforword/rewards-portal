...
<head>
    ...
    <link href="{{ asset('assets/css/admin4.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="connect-container align-content-stretch d-flex flex-wrap">
        <div class="page-sidebar">
            ...
            <div class="logo-box">
                <a href="../studentIndex" class="logo-text"> LeapForWord </a>
            ...
            <div class="page-sidebar-inner slimscroll">
                <ul class="accordion-menu">
                    ...
                    <li class="{{ 'studentIndex' == request()->path() ? 'active-page' : '' }}">
                        <a href="../studentIndex" class="{{ 'studentIndex' == request()->path() ? 'active' : '' }}"><i class="material-icons-outlined">dashboard</i>Dashboard </a>
                    </li>
                    <li class="{{ 'studentProfile' == request()->path() ? 'active-page' : '' }}">
                        <a href="../studentProfile" class="{{ 'studentProfile' == request()->path() ? 'active' : '' }} "><i class="material-icons-outlined">account_circle</i>Profile</a>
                    </li>
                    <li class="{{ 'studentActivities' == request()->path() ? 'active-page' : '' }}">
                        <a href="../studentActivities" class="{{ 'studentActivities' == request()->path() ? 'active' : '' }}"><i class="material-icons-outlined">inbox</i>Activities</a>
                    </li>
                </ul>
            </div>
        </div>
